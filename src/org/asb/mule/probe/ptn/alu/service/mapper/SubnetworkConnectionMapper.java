...

{
...

	{
		...
		tt.setTag1(vendorEntity.name[2].value);
		...
		for (NameAndStringValue_T info : vendorEntity.additionalInfo) {
			if (info.name.equals("serverTrailRefs")) {
				tt.setParentDn(info.value);
				break;
			}
		}
